          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-10 lg:sticky lg:top-32">
            ...
            <div className="pt-8 border-t border-border space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <a href="https://www.linkedin.com/in/karthikgolla/" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-secondary border border-border text-foreground hover:bg-primary/10 hover:text-primary transition-all">
